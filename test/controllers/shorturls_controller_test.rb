...
class ShorturlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shorturl" do
    assert_difference('Shorturl.count') do
      post shorturls_url, params: { shorturl: { shorturl: @shorturl.shorturl, targeturl: @shorturl.targeturl, user_id: @shorturl.user_id } }
    end
  ...
  test "should update shorturl" do
    patch shorturl_url(@shorturl), params: { shorturl: { shorturl: @shorturl.shorturl, targeturl: @shorturl.targeturl, user_id: @shorturl.user_id } }
